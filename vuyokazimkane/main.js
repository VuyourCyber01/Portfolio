...
if ("https://github.com/VuyourCyber01/Portfolio" === currentURL) {
    var e, t = document.getElementById("footer-wala-avatar");
    document.getElementById("nav-avatar").src = "https://github.com/VuyourCyber01/Pictures/issues/3#issue-2235165846";//smallavatar
    t.src = "https://github.com/VuyourCyber01/Pictures/issues/4#issue-2254554131";//bigavatar(mobile eyes)
}

function visualmode() {
    document.body.classList.toggle("light-mode");
    document.querySelectorAll(".needtobeinvert").forEach(function (e) {3
...
console.log("%c Code & Design by Vuyokazi Mkane", "background: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;");
